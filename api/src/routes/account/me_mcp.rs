...
use crate::mcp::apply::roll_agent_for_user;
use crate::mcp::oauth::{drop_oauth_tokens, has_oauth_tokens};
use crate::mcp::registry::{has_user_credentials, list_mcp_servers, set_user_credentials};
...
pub async fn put(
    ...
    tokio::spawn(async move {
        // Config truth first…
        let _ = crate::fleet::render::render_fleet(&pg, &sb_, None).await;
