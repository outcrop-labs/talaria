...
pub async fn patch(
    ...
    if let Some(gate) = crate::params::uuid_gate("workchains", "PATCH", &id) {
        return gate;
    }
...
pub async fn delete(
    ...
    if let Some(gate) = crate::params::uuid_gate("workchains", "DELETE", &id) {
        return gate;
    }
...
pub async fn post_step(
    ...
    if let Some(gate) = crate::params::uuid_gate("workchains", "POST step", &id) {
        return gate;
    }
    let parsed = parse(&body);
    let obj = match as_object(&parsed) {
...
pub async fn delete_step(
    ...
    if let Some(gate) = crate::params::uuid_gate("workchains", "DELETE step", &id) {
        return gate;
    }
    if let Some(gate) = crate::params::uuid_gate("workchains", "DELETE step task", &task_id) {
        return gate;
    }
