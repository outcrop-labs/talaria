...
pub async fn get(
    ...
    let origin = crate::google::oauth::resolve_origin(origin.as_deref(), &headers, &uri);
...
pub async fn put_login(
    ...
    if let Err(e) = crate::google::client::set_google_login_enabled(&state.pg, enabled).await {
