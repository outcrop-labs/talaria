...
use crate::body::{as_object, optional_string_array_member, parse, zod_type_name};
use crate::error::{house_error, thrown_internal_error};
use crate::permissions::PERM_IDS;
...
use crate::users::MANAGE_VIEW_ROUTES;
use axum::Json;
        ...
        let map = match perms {
            ...
            other => {
                return house_error(
                    ...
                    &crate::body::object_msg(zod_type_name(other)),
                );
            }
        };
    ...
    for (perm, val) in map {
        ...
        let allowed = match val {
            ...
            other => {
                return Err(house_error(
                    StatusCode::BAD_REQUEST,
                    &crate::body::boolean_msg(zod_type_name(other)),
                ));
            }
        };
