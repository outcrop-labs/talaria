...
impl From<crate::google_connections::RequireError> for GoogleError {
    fn from(e: crate::google_connections::RequireError) -> Self {
        match e {
            crate::google_connections::RequireError::NotConnected => GoogleError::NotConnected,
            crate::google_connections::RequireError::Failed(m) => GoogleError::Failed(m),
        }
    }
}
...
impl From<crate::google_calendar::CalendarError> for GoogleError {
    fn from(e: crate::google_calendar::CalendarError) -> Self {
        match e {
            crate::google_calendar::CalendarError::NotConnected => GoogleError::NotConnected,
            crate::google_calendar::CalendarError::Failed(m) => GoogleError::Failed(m),
        }
    }
}
