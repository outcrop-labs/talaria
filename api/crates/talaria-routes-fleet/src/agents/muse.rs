...
use talaria_api_facades::gateway::guard::redact_secrets;
use talaria_api_facades::gateway::guard::{GuardMode, guard_config};
use talaria_api_facades::harness::define::HarnessDefinition;
use talaria_api_facades::harness::run::{
...
fn structured_answer(
    res: Result<
        Result<talaria_api_facades::harness::run::HarnessResult, HarnessError>,
...
mod tests {
    use super::*;
    use talaria_api_facades::harness::run::HarnessResult;
