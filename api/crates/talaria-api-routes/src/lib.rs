// The routes crate — every handler module, the facade modules the handlers
// address engines through, and THE router (built here so integration tests
// drive the exact stack the process serves).
