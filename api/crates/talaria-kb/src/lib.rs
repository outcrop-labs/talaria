...
use talaria_email::email_escape;
use talaria_internal_history::snapshot;
use talaria_kb_perms::{EditorGrant, Guarded, ITEM_DOC, ITEM_SPACE, can_read, list_editors};
use talaria_retrieval_embed::{self, EmbedDeps};
use talaria_retrieval_qdrant::{self, QdrantDeps};
use talaria_retrieval_sources::{
...
pub async fn search_docs(
    ...
    use sqlx::Row;
    let team_ids = talaria_teams::team_ids_for_user(pg, viewer.user_id)
        .await
        .unwrap_or_default();
