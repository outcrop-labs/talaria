...
use talaria_api_facades::google::gmail::{create_label_with_token, list_labels_with_token};
...
pub async fn get(State(state): State<AppState>, headers: HeaderMap) -> Result<Response, Response> {
    ...
    Ok(match list_labels_with_token(&google.token).await {
...
pub async fn post(
    ...
    Ok(match create_label_with_token(&google.token, &name).await {
