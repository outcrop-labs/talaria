...
| [`apps/`](./apps) | **Talaria apps** — self-contained TypeScript apps this instance compiles (marketplace or git). Ships the `contacts` reference app + dev guide | see [`apps/README.md`](./apps/README.md) |
