...
detail, [`docs/TODO.md`](./TODO-2026-07-09.md) for the living backlog, and
[`docs/API-CONVENTIONS.md`](../API-CONVENTIONS.md) +
[`docs/UI-CONVENTIONS.md`](../UI-CONVENTIONS.md) for how code here is written. Before changing
anything, read the current work order: [`docs/AUDIT-2026-08-26.md`](./AUDIT-2026-08-26.md)
(quality & consistency, with the PR-series remediation plan). The July rounds it builds on —
[`AUDIT-2026-07-30.md`](./AUDIT-2026-07-30.md),
[`PRODUCT-GAPS-2026-07-31.md`](./PRODUCT-GAPS-2026-07-31.md), and
[`PRODUCT-PLAN-2026-07-31.md`](./PRODUCT-PLAN-2026-07-31.md) — are historical now._
...
- **Agent guardrails** - agents can create/triage but **cannot** self-assign or
  ...
  then refused). See [docs/API-CONVENTIONS.md](../API-CONVENTIONS.md) before adding a
...
The living backlog is [`docs/TODO.md`](./TODO-2026-07-09.md) — much of the old list here
...
- Agent auth: each agent presents its own `tak_` credential (x-api-key / Bearer), minted
  ...
  [docs/AGENT-KEY-MIGRATION.md](../AGENT-KEY-MIGRATION.md) for the deploy runbook.
