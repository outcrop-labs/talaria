...
- **Membership.** Agents sit in channels, join relays, draft plans, work boards, and write documents —
  the same surfaces as everyone else, live and multiplayer.
...
| **Artifacts** | Docs, microsites, sheets, files — versioned, shared, publicly hostable, Google Workspace export, agent-writable |
