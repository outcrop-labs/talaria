...
{:else}
  <div
    class={cn('group flex items-center gap-2 rounded-md px-2 py-1.5 text-sm transition-colors', active ? 'bg-card text-fg' : 'text-muted hover:dither-fill hover:text-fg')}
