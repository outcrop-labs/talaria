...
<div class="space-y-6" data-obs-sections>
  ...
  <Panel>
    <button type="button" onclick={() => onOpen('alerts')} class="group -mx-1.5 mb-3 flex min-h-6 w-[calc(100%+0.75rem)] items-center gap-2 rounded px-1.5 text-left transition-colors duration-[120ms] hover:dither-fill">
  ...
  <Panel>
    <button type="button" onclick={() => onOpen('audit')} class="group -mx-1.5 mb-3 flex min-h-6 w-[calc(100%+0.75rem)] items-center gap-2 rounded px-1.5 text-left transition-colors duration-[120ms] hover:dither-fill">
