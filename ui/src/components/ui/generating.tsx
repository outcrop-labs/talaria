...
// breathe (ambient background monitor), pulse (two-state fallback — also the
// reduced-motion swap, handled in styles.css). Calmer than a spinner, honest
// about indeterminate work. Use `lines={0}` for just the status line.

export type GeneratingVariant = 'weave' | 'scan' | 'breathe' | 'pulse'
