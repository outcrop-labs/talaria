...
<button
  ...
  onclick={onToggle}
  aria-expanded={open}
  class="flex w-full items-center gap-1 rounded-md py-1 pl-1 pr-2 text-left text-[11px] text-muted transition-colors duration-[120ms] hover:bg-hover hover:text-fg"
>
