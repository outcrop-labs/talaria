...
export async function* streamChat(
  params: { model: string; conversationId?: string; content: string; tier?: string; effort?: string; attachmentIds?: string[]; refs?: Array<{ type: 'kb-doc' | 'artifact'; id: string }>; kind?: 'chat' | 'plan' | 'research' | 'ticket'; templateId?: string | null },
